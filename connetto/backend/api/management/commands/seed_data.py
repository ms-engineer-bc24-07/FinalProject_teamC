...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users = UserProfileFactory.create_batch(50, company="connettoCompany")
        ...
        for user in users:
            ...
            ParticipationFactory.create_batch(
                3, user=user, desired_dates=[desired_date]
            )
        ...
        self.stdout.write(
            self.style.SUCCESS("Successfully generated seed data for 50 users!")
        )
